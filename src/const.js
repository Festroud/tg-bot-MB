...
const text52 = 'Дубайский чизкейк. В целом торте 10 порций. ОБЯЗАТЕЛЬНО ГРЕЕМ НОЖ ПОД КИПЯТКОМ ПЕРЕД ТЕМ КАК ОТРЕЗАТЬ ПОРЦИЮ. Если в зале, то отдаем на десертной тарелке с вилкой и ножом. С собой - в тортовнице (пробивать в кипере обязательно).'
const text53 = 'тут пока что пусто, у нас нет этого десерта'
...
const text90 = 'Кофейный'
const text91 = 'Шоколадный'
const text92 = 'Айс Ти'
const text93 = 'Juice'
...
module.exports.text90 = text90
module.exports.text91 = text91
module.exports.text92 = text92
module.exports.text93 = text93